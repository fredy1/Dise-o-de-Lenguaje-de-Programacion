This is bison.inf, produced by makeinfo version 4.0 from bison.texinfo.
...

File: bison.inf,  Node: Mid-Rule Actions,  Prev: Action Types,  Up: Semantics
...

File: bison.inf,  Node: Declarations,  Next: Multiple Parsers,  Prev: Semantics,  Up: Grammar File
...

File: bison.inf,  Node: Token Decl,  Next: Precedence Decl,  Up: Declarations
...

File: bison.inf,  Node: Precedence Decl,  Next: Union Decl,  Prev: Token Decl,  Up: Declarations
...

File: bison.inf,  Node: Union Decl,  Next: Type Decl,  Prev: Precedence Decl,  Up: Declarations
...

File: bison.inf,  Node: Type Decl,  Next: Expect Decl,  Prev: Union Decl,  Up: Declarations
...

File: bison.inf,  Node: Expect Decl,  Next: Start Decl,  Prev: Type Decl,  Up: Declarations
...

File: bison.inf,  Node: Start Decl,  Next: Pure Decl,  Prev: Expect Decl,  Up: Declarations
...

File: bison.inf,  Node: Pure Decl,  Next: Decl Summary,  Prev: Start Decl,  Up: Declarations
...

File: bison.inf,  Node: Decl Summary,  Prev: Pure Decl,  Up: Declarations
...

File: bison.inf,  Node: Multiple Parsers,  Prev: Declarations,  Up: Grammar File
...

File: bison.inf,  Node: Interface,  Next: Algorithm,  Prev: Grammar File,  Up: Top
...

File: bison.inf,  Node: Parser Function,  Next: Lexical,  Up: Interface
...

File: bison.inf,  Node: Lexical,  Next: Error Reporting,  Prev: Parser Function,  Up: Interface
...

File: bison.inf,  Node: Calling Convention,  Next: Token Values,  Up: Lexical
...

File: bison.inf,  Node: Token Values,  Next: Token Positions,  Prev: Calling Convention,  Up: Lexical
...

File: bison.inf,  Node: Token Positions,  Next: Pure Calling,  Prev: Token Values,  Up: Lexical
...

File: bison.inf,  Node: Pure Calling,  Prev: Token Positions,  Up: Lexical
...

File: bison.inf,  Node: Error Reporting,  Next: Action Features,  Prev: Lexical,  Up: Interface
...

File: bison.inf,  Node: Action Features,  Prev: Error Reporting,  Up: Interface
...

File: bison.inf,  Node: Algorithm,  Next: Error Recovery,  Prev: Interface,  Up: Top
...

File: bison.inf,  Node: Look-Ahead,  Next: Shift/Reduce,  Up: Algorithm
...

File: bison.inf,  Node: Shift/Reduce,  Next: Precedence,  Prev: Look-Ahead,  Up: Algorithm
...

File: bison.inf,  Node: Precedence,  Next: Contextual Precedence,  Prev: Shift/Reduce,  Up: Algorithm
...

File: bison.inf,  Node: Why Precedence,  Next: Using Precedence,  Up: Precedence
...

File: bison.inf,  Node: Using Precedence,  Next: Precedence Examples,  Prev: Why Precedence,  Up: Precedence
...

File: bison.inf,  Node: Precedence Examples,  Next: How Precedence,  Prev: Using Precedence,  Up: Precedence
